...
function createCamera() {
  ...
  camera.position.set(23.791,18.610,70 );
...
// only uncomment if it has an animation - use 2 loaders if some models have animation or no animations
  ...
  const parrotPosition = new THREE.Vector3( 0, -5, 0 );
  loader.load( 'models/integrity.glb', gltf => onLoad( gltf, parrotPosition ), onProgress, onError );
