...
var texture0 = textureLoader.load( 'textures/cube/MilkyWay/dark-s_pz.jpg' );
var texture1 = textureLoader.load( 'textures/cube/MilkyWay/dark-s_px.jpg' );
var texture2 = textureLoader.load( 'textures/cube/MilkyWay/dark-s_nx.jpg' );
var texture3 = textureLoader.load( 'textures/cube/MilkyWay/dark-s_ny.jpg' );
var texture4 = textureLoader.load( 'textures/cube/MilkyWay/MilkyWay/dark-s_nz.jpg' );
var texture5 = textureLoader.load( 'textures/cube/MilkyWay/MilkyWay/dark-s_ny.jpg' );
...
function createMaterials() {
  ...
  const RainbowTexture = loadTexture.load("textures/uv_grid_directx.jpg");
...
// datGUI.add(interface, "roationX", 0, 1)
